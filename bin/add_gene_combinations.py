...
# coding: utf-8
"""
Add gene combinations to an AnnData object and prepare data for graphing.

This script takes an AnnData object as input, adds gene combinations based on column names,
